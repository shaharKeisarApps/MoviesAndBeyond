...
fun PaddingValues.plus(
    ...
    PaddingValues(
        start =
            calculateStartPadding(layoutDirection) + plus.calculateStartPadding(layoutDirection),
    ...
    PaddingValues(
        start =
            calculateStartPadding(layoutDirection)
                .coerceAtMost(paddingValues.calculateStartPadding(layoutDirection)),
        top = calculateTopPadding().coerceAtMost(paddingValues.calculateTopPadding()),
        end =
            calculateEndPadding(layoutDirection)
                .coerceAtMost(paddingValues.calculateEndPadding(layoutDirection)),
